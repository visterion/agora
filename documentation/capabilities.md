...
| Capability | Role |
|---|---|
| Split providers (Alpaca; Finnhub merged in but disabled by default, see `configuration.md`) | Corporate-action splits; used for EPS/Piotroski share-count adjustment |
