...
class GetRsiToolTest {
    ...
    private GetRsiTool tool(List<OhlcBar> bars) {
        return new GetRsiTool(svcWith(bars), 14, 260);
    }

    @Test void risingClosesGiveRsi100() {
        ...
        assertThat(r.output().get("rsi").decimalValue()).isEqualByComparingTo("100");
    }
